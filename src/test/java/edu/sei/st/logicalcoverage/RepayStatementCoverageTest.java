...
//        ACEG	T	        T	            10.0	T	        N/A	    10.0	    success
    ...
    public void doRepay2() {
        Repay repay = new Repay(true, true, new BigDecimal(1.00), false, false, new BigDecimal(10.00));
        assertEquals("return", repay.doRepay());
    }

    @Test
    public void doRepay3() {
        Repay repay = new Repay(true, true, new BigDecimal(1.00), true, false, new BigDecimal(9.00));
        assertEquals("not enough balance ", repay.doRepay());
    }

    @Test
    public void doRepay4() {
        Repay repay = new Repay(true, true, new BigDecimal(1), true, true, new BigDecimal(10.00));
