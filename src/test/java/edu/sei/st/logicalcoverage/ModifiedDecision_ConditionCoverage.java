...
public class ModifiedDecision_ConditionCoverage {
//        条件	                                                                路径
...
//以满足判定——每一个branch的真假都已经执行了一次
    ...
    public void doRepay2() {
        Repay repay = new Repay(false, true, new BigDecimal(10.0), true, true, new BigDecimal(10.0));
        assertEquals("card invalid or name invalid or balance <=0 ", repay.doRepay());
    }

    @Test
    public void doRepay3() {
        Repay repay = new Repay(true, false, new BigDecimal(10.0), false, false, new BigDecimal(10.0));
        assertEquals("card invalid or name invalid or balance <=0 ", repay.doRepay());
    ...
    public void doRepay4() {
        Repay repay = new Repay(true, true, new BigDecimal(0.0), true, true, new BigDecimal(10.0));
        assertEquals("card invalid or name invalid or balance <=0 ", repay.doRepay());
    }

    @Test
    public void doRepay5() {
        Repay repay = new Repay(true, true, new BigDecimal(10.0), false, true, new BigDecimal(5.0));
